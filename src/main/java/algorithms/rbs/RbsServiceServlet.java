...
@WebServlet(name = "RbsServiceServlet", urlPatterns = {"/service/rbs"})
public class RbsServiceServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ServletUtil.forward("/WEB-INF/pages/rbs_service.jsp", req, resp);
    }
}
