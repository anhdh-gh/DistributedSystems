...
@WebServlet(name = "BauChonKhongDayServlet2", urlPatterns = {"/algorithm/bau-chon-khong-day-2"})
public class BauChonKhongDayServlet2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            ServletUtil.forward("/WEB-INF/pages/bau_chon_khong_day_2.jsp", req, resp);
        } catch (NumberFormatException | NullPointerException e) {
            ServletUtil.sendRedirect("/algorithm/bau-chon-khong-day-2", req, resp);
        }
    }
